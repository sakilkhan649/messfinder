              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.chat_bubble_outline_rounded, size: 48.r, color: rolePrimaryColor),
                  ),
                  SizedBox(height: 16.h),
                  Text('No conversations yet', style: GoogleFonts.poppins(color: AppTheme.textSecondary, fontSize: 16.sp, fontWeight: FontWeight.w500)),
                  SizedBox(height: 8.h),
                  Text('Your chats will appear here.', style: GoogleFonts.poppins(color: Colors.grey.shade500, fontSize: 13.sp)),
                ],
              ),
            );
          }
                      ...
                      child: Row(
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: Border.all(color: rolePrimaryColor.withValues(alpha: 0.2), width: 2),
                            ),
                            child: CircleAvatar(
                              radius: 26.r,
                              ...
                              child: otherUserPhoto == null || otherUserPhoto.isEmpty
                                  ? Icon(Icons.person_rounded, size: 28.r, color: rolePrimaryColor)
                                  : null,
                            ),
                          ),
                          SizedBox(width: 16.w),
