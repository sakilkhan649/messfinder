...
class SavedPostsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final rolePrimaryColor = isLandlord ? const Color(0xFF059669) : const Color(0xFF1E1B4B);
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.favorite_border_rounded,
                        size: 56.r, color: rolePrimaryColor),
                  ),
                        ...
                        children: [
                          Expanded(
                            child: FutureBuilder<Map<String, dynamic>?>(
                              initialData: postController.landlordProfilesCache[post.ownerUid],
                              future: postController.landlordProfilesCache.containsKey(post.ownerUid)
                                  ? null 
                                  : postController.getLandlordProfile(post.ownerUid),
                              builder: (context, snapshot) {
                                final profile = snapshot.data;
                                final name = profile?['name']?.toString() ?? 'Landlord / Manager';
                                final photoUrl = profile?['photoUrl']?.toString();
                                final fullPhone = post.ownerPhone ?? profile?['phone']?.toString() ?? '017********';
                                final maskedPhone = fullPhone.length > 5 ? '${fullPhone.substring(0, 5)}******' : '017******';

                                return Row(
                                  children: [
                                    CircleAvatar(
                                      radius: 20.r,
                                      backgroundColor: rolePrimaryColor.withValues(alpha: 0.1),
                                      backgroundImage: (photoUrl != null && photoUrl.isNotEmpty) ? NetworkImage(photoUrl) : null,
                                      child: (photoUrl == null || photoUrl.isEmpty) ? Icon(Icons.person, size: 22.r, color: rolePrimaryColor) : null,
                                    ),
                                    SizedBox(width: 10.w),
                                    Expanded(
                                      child: Column(
                          ...
                          // Favorite Button
                          GestureDetector(
                            onTap: () => postController.toggleSavePost(post.postId),
                            child: Container(
                          ...
                          ClipRRect(
                            ...
                            child: post.images.isNotEmpty
                                ...
                                : Container(
                                    ...
                                    child: Icon(Icons.home_work_rounded, color: Colors.grey.shade400, size: 40.r),
                                  ),
                          ),
                          SizedBox(width: 12.w),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Icon(Icons.location_on_rounded, size: 14.r, color: Colors.grey.shade500),
                                    SizedBox(width: 4.w),
                                    Expanded(
                                      child: Text(
                                        post.address,
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    _buildTag(
                                      ...
                                      post.bachelorType.capitalizeFirst ?? post.bachelorType,
                                      rolePrimaryColor.withValues(alpha: 0.08), 
                                      rolePrimaryColor
                                    ),
                                    _buildTag(
