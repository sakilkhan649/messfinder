...
exports.internalSendPushNotification = async ({ receiverUid, title, body, type, relatedId, senderUid, senderPhotoUrl, isVideo, token }) => {
  ...
  try {
    ...
    const message = {
      ...
      data: {
        ...
        token: token || '',
        isVideo: isVideo !== undefined ? String(isVideo) : '',
